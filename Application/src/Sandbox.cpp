...
void gameEngine::createEngine(GameWindow* som) {
	...
	std::shared_ptr <gameEngine::ObjectRender> somLoad = std::make_shared <gameEngine::Cube>(*new Cube(glm::vec3(0.f), glm::vec3(0.f), 1.f, 1.f, 1.f, cubeShader));
	...
	som->addTex(fro->getFBO()->textures[0]);
